...
import com.cynic1254.avalitheme.client.rendering.textures.TextureIdentifierDefinition.TextureIdentifierObject;
import com.cynic1254.avalitheme.client.rendering.textures.TextureIdentifierDefinition.BlendMode;
...
public record GeoCitizenDefinition(
    ...
    public GeoCitizenDefinition {
        if (model == null) {
            model = ResourceLocation.fromNamespaceAndPath(AvaliTheme.MODID, "default");
        }
        if (attachments == null) {
        ...
        if (texture == null) {
            texture = new TexturePipeline(
                    new BaseTexture(ResourceLocation.fromNamespaceAndPath(AvaliTheme.MODID, "missingno"), List.of()),
                    List.of()
            );
        }
    }
    ...
    public record AttachmentMesh(
        ...
        public AttachmentMesh {
            if (mesh == null) mesh = ResourceLocation.fromNamespaceAndPath(AvaliTheme.MODID, "default");
    ...
    public record TexturePipeline(
        ...
        public TexturePipeline {
            if (base == null) {
                base = new BaseTexture(ResourceLocation.fromNamespaceAndPath(AvaliTheme.MODID, "missingno"), List.of());
            }
    ...
    public record BaseTexture(
        ...
        public BaseTexture {
            if (texture == null) texture = ResourceLocation.fromNamespaceAndPath(AvaliTheme.MODID, "missingno");
